...
public class Employee {
	...
	public void setRegistrationNumber(String registrationNumber)throws Exception{
		...
		if (checkRegistrationNumber(registrationNumber) == true) {
			...
			IllegalArgumentException e = new IllegalArgumentException("ERROR: The new registration number isn't valid !");
			throw e;
		}
	}
	...
	public void setLastName(String lastName) throws Exception{
		if (checkName(lastName) == true) {
			...
			IllegalArgumentException e = new IllegalArgumentException("ERROR: The last Name isn't valid !");
			throw e;
		}
	}
	...
	public void setFirstName(String firstName)throws Exception{
		...
		this.firstName = firstName;
			...
			//throw new Exception("ERROR: the first name isn't valid !");
			IllegalArgumentException e = new IllegalArgumentException("ERROR: The first name isn't valid !");
			throw e;
		}
	}
	...
	public void setBirthDay(String birthDay){
		if(checkBirthDate(birthDay) == true){
			...
			IllegalArgumentException e = new IllegalArgumentException("ERROR: The birth date isn't valid !");
			throw e;
		}
